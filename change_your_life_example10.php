        ...
        <div class="body-content-wrapper">
            ...
            <div class="birth-of-ministry-page-wrapper">
                <div class="container">
                    ...
                    <div class="float-image width-auto">
                        <img src="./assets/woman1.png" alt="Woman Image 1"/>
                    </div>
                    ...
                    <p>As a rule, people are led by their eyesightoy, ss, self-control. ons will change only though manifestation of the fruit of the Spirit. Even if the person who causes harm does not change, </p>
                </div>
                <div class="testimonies-long-title-wrapper">
                    <div class="container">
                        <div class="multiple-image-wrapper multiple-image-flex" style="margin: 0">
                            <img style="width: 100%;" src="./assets/older-garden-background.png" alt="Image 1"/>
                        </div>
                    </div>
                </div>
                <div class="container">
                    <p>As a rule, people are led by their eyesightoy, ss, self-control. ons will change only though manifestation of the fruit of the Spirit. Even if the person who causes harm does not change, the one who manifests the fruit of the Spirit will be built up, will please God and will grow in godliness.  </p>
                    <div class="multiple-image-wrapper multiple-image-flex" style="margin: 0; gap: 0">
