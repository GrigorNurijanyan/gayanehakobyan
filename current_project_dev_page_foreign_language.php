    ...
    <div class="wrapper">
        ...
        <div class="body-content-wrapper">
            <div class="body-slider-wrapper">
                <img src="./assets/foreign-language-background.png" alt="Foreign Language Img"/>
            </div>
                ...
                <div class="container">
                    <div class="video-with-text-and-images-wrapper">
                        ...
                        <div class="kitchen-trainings-wrapper">
                            <img src="./assets/foreign-language.png" alt="Foreign Img"/>
                        </div>
                    </div>
                    <div class="multiple-video-wrapper multiple-video-for-kitchen-training">
                        <div class="frame-item">
                            <h6>Leraning English Phase 1 <div class="part-video">Part 1</div></h6>
                            <iframe src="https://www.youtube.com/embed/xQTCqAY-32c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="frame-item">
                            <h6>Leraning English Phase 1 <div class="part-video">Part 2</div></h6>
                            <iframe src="https://www.youtube.com/embed/xQTCqAY-32c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
