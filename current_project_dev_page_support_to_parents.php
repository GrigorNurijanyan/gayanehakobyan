    ...
    <div class="wrapper">
        ...
        <div class="body-content-wrapper">
            <div class="body-slider-wrapper">
                <img src="./assets/support-to-parents-background.png" alt="Support to Parents Img"/>
            </div>
            <div class="birth-of-ministry-page-wrapper">
                <div class="container">
                    <div class="video-with-text-and-images-wrapper">
                        ...
                        <img src="./assets/thank-you-2017.png" alt="Thank You img"/>
                    </div>
                </div>
                <div class="testimonies-long-title-wrapper">
                    <div class="container">
                        <div class="multiple-image-wrapper multiple-image-flex">
