    ...
    <div class="wrapper">
        ...
        <div class="body-content-wrapper">
            <div class="body-slider-wrapper">
                <img src="./assets/painting_background.png" alt="Painting Img"/>
            </div>
            <div class="birth-of-ministry-page-wrapper">
                <div class="container">
                    ...
                    <div class="dev-page-dancing-wrapper">
                        <div class="dancing-block-wrapper">
                            Image Gallery
                            <img src="./assets/painting1-border.png" alt="Painting Border Img"/>
                        </div>
                    </div>
                    <div class="multiple-image-gallery">
                        <div class="image-item">
                            <h6>PAINTING TIME OF OUR CHILDREN </h6>
                            <h5>2016</h5>
                            <img src="./assets/help-disabilities-people-background.png" alt="Image 1">
                        </div>
                        <div class="image-item">
                            <h6>AINTING TIME OF OUR CHILDREN </h6>
                            <h5>2017</h5>
                            <img src="./assets/help-disabilities-people-background.png" alt="Image 1">
                        </div>
                        <div class="image-item">
