    ...
    <div class="wrapper">
        ...
        <div class="body-content-wrapper">
            <div class="body-slider-wrapper">
                <img src="./assets/change_your_life.png" alt="Kitchen Training Img"/>
            </div>
            <div class="birth-of-ministry-page-wrapper">
                <div class="condition-parts-items-wrapper">
                    <div class="container">
                        <div class="left-part">
                            <h6>Conditions to answered prayer:</h6>
                            <h6>Part 1. The admonition of elihu to job</h6>
                        </div>
